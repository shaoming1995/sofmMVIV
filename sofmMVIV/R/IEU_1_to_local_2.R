...
IEU_1_to_local_2<-function(name,key,data1IV,GWASID,data2IV,data2GWAS,data3IV,data3GWAS){
  A<-name
  ...
  write.csv(exposure_dat_temp,"exposure_dat.csv",quote = F,row.names = F)}else{
