...
#'
#' @param data1IV 来自IEU暴露1的data_h_SNP_steiger数据文件
#' @param GWASID 来自IEU暴露1的GWAS ID号
#' @param data2IV 来自非IEU暴露的data_h_SNP_steiger数据文件
#' @param data2GWAS 来自非IEU暴露2的GWAS summary数据文件
#' @param data3IV 来自非IEU暴露3的data_h_SNP_steiger数据文件
#' @param data3GWAS 来自非IEU暴露3的GWAS summary数据文件
#' @param data4IV 来自非IEU暴露4的data_h_SNP_steiger数据文件
#' @param name 学号
#' @param key 密码
#' @param data4GWAS 来自非IEU暴露4的GWAS summary数据文件
#'
#' @export
IEU_1_to_local_3<-function(name,key,data1IV,GWASID,data2IV,data2GWAS,data3IV,data3GWAS,data4IV,data4GWAS){
  A<-name
