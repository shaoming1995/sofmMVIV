...
#' @param data5IV 来自非IEU暴露4的data_h_SNP_steiger数据文件
#' @param name 学号
#' @param key 密码
#' @param data5GWAS 来自非IEU暴露4的GWAS summary数据文件
#'
#' @export
IEU_0_to_local_5<-function(name,key,data1IV,data1GWAS,data2IV,data2GWAS,data3IV,data3GWAS,data4IV,data4GWAS,data5IV,data5GWAS){
  A<-name
